        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="form-group">
              <h1 class="m-0 text-danger mt-3">New Meeting Type</h1>
            </div>
            </div><!-- /.col -->
                      <div class="col-md-8">
              <ol class="breadcrumb float-sm-right">
                <li class="">
                      ...
                      <a class="btn btn-app text-danger" id="close" href="{{route('meetingtypes.index')}}">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Meeting Type Infomation</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="InputEmail1" placeholder="Enter Meeting Type">
                            </div>
