    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="form-group">
          <h1 class="m-0 text-danger mt-3">Meeting Type</h1>
        </div>
        </div><!-- /.col -->
                  <div class="col-md-8">
          <ol class="breadcrumb float-sm-right">
            <li class="">
                  <a class="btn btn-app text-success" id="" href="{{route('meetingtypes.create')}}">
...
<div class="card">
  ...
  <!-- /.card -->
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Meeting Type Information</h3>
