        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="form-group">
              <h1 class="m-0 text-danger mt-3">ParticipantHoster</h1>
            </div>
            </div><!-- /.col -->
                      <div class="col-md-8">
              <ol class="breadcrumb float-sm-right">
                <li class="">
                      <a class="btn btn-app text-success" id="" href="{{route('participants.create')}}">
            ...
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Participant Title"
                                    value="">
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                <label>Participant Country</label>
